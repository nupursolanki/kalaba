             ...
             <li class="widget-container widget_text">
                ...
                <div class="my-only-widget-content " >
                        ...
                        <li>   
                                ...
                                <p class="rf2"><?php echo sprintf (__('Width: %s','shipme'), shipme_get_dimension_thing( get_post_meta($pid,'width',true), shipme_get_dimensions_measure())); ?></p>	
                        </li>
                        
                        
                         <li>   
                                <p class="rf1"><img src="<?php bloginfo('template_url') ?>/images/bullet_accept.png" width="22" /></p> 
                                <p class="rf2"><?php echo sprintf (__('Height: %s','shipme'), shipme_get_dimension_thing( get_post_meta($pid,'height',true), shipme_get_dimensions_measure())); ?></p>	
                        </li>
                        
                        
                         <li>   
                                <p class="rf1"><img src="<?php bloginfo('template_url') ?>/images/bullet_accept.png" width="22" /></p> 
                                <p class="rf2"><?php echo sprintf (__('Length: %s','shipme'), shipme_get_dimension_thing( get_post_meta($pid,'length',true), shipme_get_dimensions_measure())); ?></p>	
                        </li>
                        
                        
                         <li>   
                                <p class="rf1"><img src="<?php bloginfo('template_url') ?>/images/bullet_accept.png" width="22" /></p> 
                                <p class="rf2"><?php echo sprintf (__('Weight: %s','shipme'), shipme_get_dimension_thing( get_post_meta($pid,'weight',true), shipme_get_weight_measure())); ?></p>	
                        </li>
                    </ul> 
