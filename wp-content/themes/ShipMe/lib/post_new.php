...
function shipme_theme_post_new_function() {
    ...
    if (isset($_GET['jobid'])) {
        $jobid = $_GET['jobid'];
        //echo $jobid;
        if (get_post_status($jobid) == 'publish') {
            ...
            if (get_current_user_id() == $author_id) {
                ...
                echo '<div class="total-content-area note-note ">You Can not able To Edit Job.</div>';
                exit;
                ?>
    ...
    <div class="container_ship_no_bk">
        <div class="total-content-area col-xs-12 col-sm-12 col-lg-12">
            ...
            if ($new_job_step == "4") {
                ...
                if (empty($shipme_job_period))
                    $shipme_job_period = 30;
                ...
                //----------------------------------------
                $finalize = isset($_GET['finalize']) ? true : true;
...
<!--                        <li>
                ...
                ?>  /> You want Helper For carry Loaded Package?</p>
                        ...
                        if (empty($shipme_featured_fee) or $shipme_featured_fee <= 0)
                            $sl = '';


                        printf(__("By clicking this checkbox you mark your job as featured. %s", 'shipme'), $sl);
                        ?></p>
                             </li>
                        ...
                        if ($shipme_enable_sealed_option != "no"):
                            ...
                            $shipme_sealed_bidding_fee = get_option('shipme_sealed_bidding_fee');
                            $sl = __('Extra fee is applied', 'shipme');
                            if (empty($shipme_sealed_bidding_fee) or $shipme_sealed_bidding_fee <= 0)
                                $sl = '';
                                ...
                                <script>
                                    ...
                                    jQuery(document).ready(function () {
                                        ...
                                        jQuery('.select_div').change(function () {
                                            ...
                                            if (jQuery(this).attr("value") == "login_user") {
                                                jQuery(".register_user").hide();
                                                jQuery(".login_user").show();
                                            }
                                            if (jQuery(this).attr("value") == "register_user") {
                                                jQuery(".login_user").hide();
                                                jQuery(".register_user").show();
                                            }
